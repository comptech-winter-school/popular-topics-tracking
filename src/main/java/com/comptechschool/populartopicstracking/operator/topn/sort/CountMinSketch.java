...
/*        CountMinSketch.Hasher<Long> hasher1 = number1 -> firstHashFunc(number1) + secondHashFunc(number1, 1);
        ...
        Hasher<Long> hasher3 = number3 -> String.valueOf(number3).hashCode();
        Hasher<Long> hasher5 = number5 -> String.valueOf(number5).hashCode();
        Hasher<Long> hasher6 = number6 -> String.valueOf(number6).hashCode();
        Hasher<Long> hasher7 = number7 -> String.valueOf(number7).hashCode();
        Hasher<Long> hasher8 = number8 -> String.valueOf(number8).hashCode();
        Hasher<Long> hasher9 = number9 -> String.valueOf(number9).hashCode();
        Hasher<Long> hasher10 = number10 -> String.valueOf(number10).hashCode();
