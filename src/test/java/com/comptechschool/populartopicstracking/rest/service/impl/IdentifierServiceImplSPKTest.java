...
class IdentifierServiceImplSPKTest {

    @Mock
    private IdentifierRepository identifierRepository;

    @InjectMocks
    private IdentifierServiceImplSPK identifierServiceImplSPK;
    ...
    void getTopNIdentifiers() {
        ...
        List<IdentifierDto> actualIdentifierDtoList = identifierServiceImplSPK.getTopNIdentifiers(2);
    ...
    void getIdentifierById() {
        ...
        expectedIdentifierDto.setFrequency(794L);

        Mockito.when(identifierRepository.findById(1L)).thenReturn(Optional.of(identifier));
        IdentifierDto actualIdentifierDto = identifierServiceImplSPK.getIdentifierById(1L);
...
//given
        ...
        //when
        Mockito.when(identifierRepository.findAll()).thenReturn(identifierList);
        List<IdentifierDto> actualIdentifierDtoList = identifierServiceImplSPK.getAllIdentifiers();
